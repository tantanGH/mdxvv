...
[MDXVV081.ZIP](https://github.com/tantanGH/mdxvv/raw/main/MDXVV081.ZIP) をダウンロードして展開し、MDXVV.X をパスの通ったディレクトリにコピーします。
...
- version 0.8.0 (2023/04/15) ... 低クロック機向け改善。ただしX68000Zではかなり厳しい
