...
[MDXVV095.ZIP](https://github.com/tantanGH/mdxvv/raw/main/MDXVV095.ZIP) をダウンロードして展開し、MDXVV.X をパスの通ったディレクトリにコピーします。
...
- version 0.9.5 (2026/03/21) ... ビルド環境を elf2x68k + newlib に移行した
