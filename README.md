...
注意：低クロック機ではもたつきなどが発生します。できるだけXVI(16MHz)、いやRedZone(24MHz)相当以上でお使いください...。メモリも最低4MBは必要です。エミュレータ上ではMC68000 24MHz/4MBあればほぼこちらの期待する動きになることを確認しています。推奨は060turboまたはPhantomXです(ぉ
